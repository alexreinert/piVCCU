...
wget -q -O $CNT_ROOTFS/firmware/HmIP-RFUSB/dualcopro_update_blhmip-4.2.14.eq3 https://raw.githubusercontent.com/eq-3/occu/6d64665d1eaa1f770046dd2af6c8980a4b012bd7/firmware/HmIP-RFUSB/dualcopro_update_blhmip-4.2.14.eq3
...
wget -O openjdk-8-jre.deb http://security.debian.org/debian-security/pool/updates/main/o/openjdk-8/openjdk-8-jre_8u312-b07-1~deb9u1_armhf.deb
wget -O openjdk-8-jre-headless.deb http://security.debian.org/debian-security/pool/updates/main/o/openjdk-8/openjdk-8-jre-headless_8u312-b07-1~deb9u1_armhf.deb
